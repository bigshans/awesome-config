...
theme.layout_tile                               = theme.dir .. "/icons/tilew.png"
theme.layout_tileleft                           = theme.dir .. "/icons/tileleftw.png"
theme.layout_tilebottom                         = theme.dir .. "/icons/tilebottomw.png"
theme.layout_tiletop                            = theme.dir .. "/icons/tiletopw.png"
theme.layout_fairv                              = theme.dir .. "/icons/fairvw.png"
theme.layout_fairh                              = theme.dir .. "/icons/fairhw.png"
theme.layout_spiral                             = theme.dir .. "/icons/spiralw.png"
theme.layout_dwindle                            = theme.dir .. "/icons/dwindlew.png"
theme.layout_max                                = theme.dir .. "/icons/maxw.png"
theme.layout_fullscreen                         = theme.dir .. "/icons/fullscreenw.png"
theme.layout_magnifier                          = theme.dir .. "/icons/magnifierw.png"
theme.layout_floating                           = theme.dir .. "/icons/floatingw.png"
...
local keywatch = awful.widget.watch(
"bash -c \"xset q | grep Caps | tr -s ' ' | cut -d ' ' -f 5,9 | sed 's/on/▣/g' | sed 's/off/▢/g'\"", 0.1, function(widget, stdout)
...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            arrow(theme.bg_normal, "#343434"),
            wibox.container.background(wibox.container.margin(keywatch, 4, 8), "#343434"),
            arrow("#343434", "#777E76"),
